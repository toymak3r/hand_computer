/*
 * Projeto Thanos 
 * Author Edward Facundo
 * Email: edwardfacundo@gmail.com
 */
 
// Conexao por SPI
#include "SSD1306Spi.h"

// Imagens utilizadas no LCD
#include "images.h"

// Fontes utilizadas no gráfico
#include "fonts.h"
...
/* Esquemático de conexao do SPI com a ESP8266
...
const int scl_pin = D3; // definição do pino I2C SCL
...
const char* PASSWORD = "hiris123456";
...
/*  if ( i = iMax ){
  ...
  int y_media = media(y);
  */
  Serial.print("AcX = "); Serial.print((AcX + 15)/150);
  Serial.print(" | AcY = "); Serial.print(AcY);
  Serial.print(" | AcZ = "); Serial.print(AcZ);
  Serial.print(" | Tmp = "); Serial.print(Tmp/340.00+36.53);
  Serial.print(" | GyX = "); Serial.print((GyX+15)/150);
  Serial.print(" | GyY = "); Serial.print(-(GyY-100)/150);
  Serial.print(" | GyZ = "); Serial.print((GyZ+ 15)/150);
  Serial.print(" | Acao_1 = "); Serial.println(acao_1);
...
void drawFontFaceDemo() {
    display.setFont(Open_Sans_Condensed_Bold_13);
    display.drawString(22, 0, "Edward");
    display.setTextAlignment(TEXT_ALIGN_CENTER);
    display.drawString(64, 22, ((String)((int)(Tmp/340.00+36.53)))+'\370'+'C');
    
}

void drawPointerPosition() {
    display.setFont(Open_Sans_Condensed_Bold_13);
    display.drawString(10, 33, "Ponteiro Ativo");
    //display.drawString(120, 33, );
}
